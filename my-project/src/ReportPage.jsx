...
const ReportPage = ( ) => {
  ...
  const reportData = location.state.reportData; // Access report data passed as state
  ...
  return (
    <div>
      ...
      />
      <h2 className="text-3xl font-bold mt-6 mb-4 mb-4 text-center">Report</h2>
      <div className="flex flex-wrap justify-center items-start">
        {reportData.map((item, index) => (
          <div key={index} className="border-2 border-gray-300 m-2 p-4 rounded-xl shadow-xl flex flex-col hover:border-[#F36234]">
          <div>
          ...
          <button 
            className="py-2 px-4 text-stone-600 rounded mb-1 mt-auto self-end hover:text-[#F36234]" 
        ...
        <div className="border-2 border-gray-300 m-2 p-4 shadow-lg  rounded-xl flex flex-col hover:border-[#F36234]">
          <div>
